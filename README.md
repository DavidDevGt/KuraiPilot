...
- **Cómo contribuir**: [CONTRIBUTING.md](./CONTRIBUTING.md) · **Para agentes**: [CLAUDE.md](./CLAUDE.md) · **Cambios**: [CHANGELOG.md](./CHANGELOG.md)

No hace falta GPU para contribuir: la suite completa corre en CPU (`make test-cpu`), igual que CI.
